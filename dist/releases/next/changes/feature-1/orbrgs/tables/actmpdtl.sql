...
-- changeset ORBRGS:1756617450152 stripComments:false  logicalFilePath:feature-1\orbrgs\tables\actmpdtl.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
-- sqlcl_snapshot src/database/orbrgs/tables/actmpdtl.sql:null:21debb21d8f9920ac687e994503acfbd26985279:create

create table orbrgs.actmpdtl (
